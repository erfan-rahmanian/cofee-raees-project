...
<div class="overlay"></div>
       <div class="container">
         <div class="row jkhkjjkggf">
           <div class="col-12 text-center wdawddawd">
             <h2 class="banner-title ">درخواست همکاری کارمندی و نیروی انسانی</h2>
            
           
           </div>
           <div class=" rhdszzzxx" dir="ltr">
               <nav aria-label="breadcrumb"  >
                   <ol class="breadcrumb ">
                     <li class="breadcrumb-item active" aria-current="page">   استخدام</li>
                     <li class="breadcrumb-item"><a href="#">فروشگاه انلاین</a></li>
