        ...
        <header className="bg-white shadow-sm border-bottom fixed-header">
          ...
          <div style={{ backgroundColor: "#F6F6F6" }}>
            <nav className="nav nav-pills d-flex justify-content-center flex-grow-1 order-2 order-lg-1 pt-2">
              <a className="  nav-link  " href="/public/aaaa.html"> 
            <span className="ccsfsxc active" >   صفحه اصلی
            </span>
              </a>
              <a className="nav-link " href="/mahsol">
                فروشگاه آنلاین
              </a>
              <a className="nav-link " href="https://raeescoffee.com/product/%d8%a8%d8%a7%d8%b1%db%8c%d8%b3%d8%aa%d8%a7-%d9%88-%d8%a8%d8%b1%d9%88%d8%a6%db%8c%d9%86%da%af/">
                کافه رییس
              </a>
              <a className="nav-link " href="/daste">
                آکادمی رییس
              </a>
              <a className="nav-link " href="/majale.org">
                رسانه رییس
              </a>
